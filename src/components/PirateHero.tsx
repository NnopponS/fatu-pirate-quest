import { Anchor, Gift, LogIn, Map } from "lucide-react";
    ...
    <div className="min-h-screen bg-parchment relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="text-center mb-12 animate-in fade-in slide-in-from-top duration-700">
          ...
          <p className="text-2xl md:text-3xl text-pirate-wood mb-2">Fatu Open House 2025</p>
          <p className="text-lg text-muted-foreground">7-8 พฤศจิกายน 2568</p>
        </div>

        <div className="max-w-4xl mx-auto bg-card/80 backdrop-blur rounded-2xl border-2 border-rope p-8 shadow-2xl">
          <div className="text-center mb-8 space-y-3">
            <h2 className="text-3xl font-bold text-primary">ออกล่าสมบัติกับเรา! ⚓</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="text-center p-6 bg-secondary/10 rounded-xl border border-secondary/30">
              ...
              <p className="text-sm text-muted-foreground">เที่ยวชมและเช็กอินด้วย QR</p>
            </div>
            ...
            <div className="text-center p-6 bg-accent/10 rounded-xl border border-accent/30">
              ...
              <p className="text-sm text-muted-foreground">สะสมแล้วหมุนวงล้อลุ้นรางวัล</p>
            </div>
            ...
            <div className="text-center p-6 bg-primary/10 rounded-xl border border-primary/30">
              ...
              <p className="text-sm text-muted-foreground">สติ๊กเกอร์ พวงกุญแจ และอื่น ๆ</p>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="text-lg gap-2" onClick={() => navigate("/signup")}>
              🏴‍☠️ ลงทะเบียนเข้าร่วม
            </Button>
            <Button
              size="lg"
        ...
        <div className="mt-12 text-center text-sm text-muted-foreground">
          <p>พร้อมออกเดินเรือสู่การผจญภัยครั้งใหม่ที่คณะศิลปกรรมศาสตร์ มธ. เจอกันที่ FATU Open House!</p>
        </div>
      </div>
    </div>
  );
